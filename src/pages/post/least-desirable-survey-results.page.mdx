...
import MaoExplosion from "../../../assets/MaoExplosion.png"
...
export const meta = {
  ...
  dateCreated: 1676594982497,
  dateUpdated: 1676595334910
}

# part 2! the ensemble stars characters that are least desirable for marriage!

<CardCG src={MaoExplosion.src} alt="exploded mao" />

hello everyone and welcome back! this time, we're going over the ensemble stars characters that were voted to be LEAST desirable for marriage. you can see the results for the most desirable to marry over [here](/post/most-desirable-survey-results).
...
by the way, son did not write the rest of this article! that's because son bit off more than she could chew... this article was actually automated in python by [@mp39s](https://twitter.com/mp39s)! everyone go thank them!
...
<CardCG src="https://static.wikia.nocookie.net/ensemble-stars/images/6/6a/%28Rookie_Skater%29_Tsukasa_Suou_CG.png" alt="Tsukasa Suou" caption='"rip bozos lmao"' />

## 53RD PLACE -- SOUMA KANZAKI (1 votes)
...
> [www.quora.com/Are-katanas-legal-in-Japan](https://www.quora.com/Are-katanas-legal-in-Japan)
...
## 49TH PLACE -- TOMOYA MASHIRO (2 votes)
...
## 49TH PLACE -- SHINOBU SENGOKU (2 votes)
...
## 46TH PLACE -- ADONIS OTOGARI (3 votes)
...
## 44TH PLACE -- KOHAKU OUKAWA (4 votes)
...
## 41ST PLACE -- ARASHI NARUKAMI (5 votes)
...
## 38TH PLACE -- TETORA NAGUMO (6 votes)
...
## 38TH PLACE -- HOKUTO HIDAKA (6 votes)
...
## 38TH PLACE -- YUZURU FUSHIMI (6 votes)
...
## 33RD PLACE -- AKIOMI KUNUGI (8 votes)
...
## 33RD PLACE -- MITSURU TENMA (8 votes)
...
## 31ST PLACE -- SORA HARUKAWA (9 votes)
...
<CardCG src="https://static.wikia.nocookie.net/ensemble-stars/images/9/91/%28Minotaur%27s_Trial%29_Niki_Shiina_CG.png" alt="Niki Shiina" caption="niki sweetie who did this to you..." />
...
## 30TH PLACE -- SUBARU AKEHOSHI (10 votes)
...
## 27TH PLACE -- MIDORI TAKAMINE (12 votes)
...
## 23RD PLACE -- CHIAKI MORISAWA (15 votes)
...
## 21ST PLACE -- NATSUME SAKASAKI (19 votes)
...
## 20TH PLACE -- AIRA SHIRATORI (20 votes)
...
## 18TH PLACE -- MADARA MIKEJIMA (21 votes)
...
## 16TH PLACE -- KANATA SHINKAI (22 votes)
...
## 13TH PLACE -- TATSUMI KAZEHAYA (23 votes)
...
<CardCG src="https://static.wikia.nocookie.net/ensemble-stars/images/2/2d/%28Binding_Ariadne%29_HiMERU_CG.png" alt="Ariadne%29 Himeru" caption="whatever. more for me. bozos." />
...
## 6TH PLACE -- LEO TSUKINAGA (30 votes)

<CardCG src="https://static.wikia.nocookie.net/ensemble-stars/images/0/0e/%28Beyond_Our_Destination%2C_the_World%27s_Mysteries%29_Leo_Tsukinaga_CG.png" alt="Leo Tsukinaga" caption="yall were so mean to him???" />
...
## 5TH PLACE -- TORI HIMEMIYA (57 votes)

<CardCG src="https://static.wikia.nocookie.net/ensemble-stars/images/6/64/%28Snow_White_Brim%29_Tori_Himemiya_CG.png" alt="Tori Himemiya" caption="im so sorry tori </3" />
...
## 2ND PLACE -- EICHI TENSHOUIN (71 votes)
